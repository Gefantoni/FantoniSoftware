...
const PAGINAS = [
  ...
  { arquivo: 'precos.html',       url: '/precos',       priority: '0.9', changefreq: 'monthly' },
  { arquivo: 'sistema-pdv/bar-restaurante.html', url: '/sistema-pdv/bar-restaurante', priority: '0.9', changefreq: 'monthly' },
